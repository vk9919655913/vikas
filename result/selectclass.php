...
<form class="w3-container" action="setsession.php" method = "post">
  <h2 class="w3-text-blue">Input Data</h2>
<p<label class="w3-text-blue"><b>Select Exam</b></label>
<select class="w3-select w3-border" name="exam"  required >
    <option value="" disabled selected>Choose your option</option>
  <option value = "1">Half Yearly Exam</option>
  <option value = "2">Annual Exam</option>
  </select>
</p>
   <p>      
